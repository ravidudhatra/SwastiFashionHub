...
namespace SwastiFashionHub.Shared.Core.Http
{
    public class HttpResponseWrapper<T>
    {
        ...
        public HttpResponseWrapper(bool success, HttpResponseMessage httpResponseMessage, IAlertService alertService)
        {
            Success = success;
        ...
        public async Task<List<string>> GetErrors()
        {
            ...
            if (HttpResponseMessage.StatusCode == HttpStatusCode.InternalServerError)
            {
                await _alertService.Danger(string.Join(",", errors), keepAfterRouteChange: true);
            }

...
namespace SwastiFashionHub.Shared.Core.Http
{
    public class HttpService : IHttpService
    {
        ...
        public HttpService(HttpClient httpClient, NavigationManager navigationManager,
            IAlertService alertService, ILogger<HttpService> logger)
        {
        ...
        public async Task<HttpResponseWrapper<T>> CreateResponseAsync<T>(HttpResponseMessage response, string url, string requestContent, string method)
        {
            try
            {
                ...
                {
                    return new HttpResponseWrapper<T>(true, response, _alertService);
                }
                ...
                return new HttpResponseWrapper<T>(false, response, _alertService);
            }
